...
describe('Transpiler', () => {
  ...
  function get_average(avg_src, avg_len) {
    ...
    $.let.fn2_cc[0] = $.const.glb1_aa[$.let.fn2_bb[0]];
    $.let.fn2_dd = $.init($.let.fn2_dd, close, 1);
    $.let.fn2_ee = $.init($.let.fn2_ee, close, $.const.glb1_aa[0]);
    $.let.fn2_ff = $.init($.let.fn2_ff, close, $.const.glb1_aa[99]);
    $.let.fn2_cc0 = $.init($.let.fn2_cc0, $.const.glb1__cc, 0);
    $.let.fn2_cc1 = $.init($.let.fn2_cc1, $.const.glb1__cc, 1);
    $.let.fn2_cc2 = $.init($.let.fn2_cc2, $.const.glb1__cc, $.const.glb1_aa[0]);
    $.let.fn2_cc3 = $.init($.let.fn2_cc3, $.const.glb1__cc, $.const.glb1_aa[99]);
  ...
  function get_average(avg_src, avg_len) {
    ...
    $.let.fn1_cc[0] = $.const.glb1_aa[$.let.fn1_bb[0]];
    $.let.fn1_dd = $.init($.let.fn1_dd, close, 1);
    $.let.fn1_ee = $.init($.let.fn1_ee, close, $.const.glb1_aa[0]);
    $.let.fn1_ff = $.init($.let.fn1_ff, close, $.const.glb1_aa[99]);
    $.let.fn1_cc0 = $.init($.let.fn1_cc0, $.const.glb1__cc, 0);
    $.let.fn1_cc1 = $.init($.let.fn1_cc1, $.const.glb1__cc, 1);
    $.let.fn1_cc2 = $.init($.let.fn1_cc2, $.const.glb1__cc, $.const.glb1_aa[0]);
    $.let.fn1_cc3 = $.init($.let.fn1_cc3, $.const.glb1__cc, $.const.glb1_aa[99]);
